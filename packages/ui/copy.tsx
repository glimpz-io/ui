    ...
    return (
        <div className="w-full flex flex-col space-y-4 items-center justify-between">
            <div className="w-full flex flex-col space-y-2 items-left justify-between">
                <p
                    className={`flex justify-center space-x-8 text-center text-base text-neutral-400 hover:text-zinc-400 bg-neutral-800 hover:bg-zinc-800 w-full px-6 py-6 outline-none font-light cursor-pointer border-2 border-neutral-600 hover:border-zinc-600 transition-colors duration-200 ${global}`}
                    onClick={() => {
